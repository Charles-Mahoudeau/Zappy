...
class CliParser {
  ...
  private:
     ...
     * are invalid.
     */
    void parseArguments(std::span<std::string_view> argv);
     ...
     */
    void ensureValidArguments() const;
     ...
     */
    void handleFlag(std::string_view flag, const std::vector<std::string_view>& flagParams);
