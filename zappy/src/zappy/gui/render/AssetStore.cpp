...
void AssetStore::loadVFXs() {
    ...
    test.setInitEnvelope(ParticleEmitter::ParticleEnvelope{.size = 0.7F, .rotation = 0.5F, .tint = 0.3F}, 0.1F, 0.3F);
    test.setIncrementParticles(Vec2D{-0.007F, -0.007F}, 1.0F, ColorF{0, 0, 0, -2.0F});
    test.setIncrementEnvelope(ParticleEmitter::ParticleEnvelope{.size = 0.1F, .rotation = 0.4F, .tint = 0.2F});
