...
void AssetStore::loadVFXs() {
    ...
    skull.setStatic(Vector3{}, Vector3{0.5F, 0.5F, 0.5F}, Vector3{0.0F, -0.00008F, 0.0F}, 0.0F, 1);
    ...
    skull.setInitEnvelope(ParticleEmitter::ParticleEnvelope{.size = 0.05F, .rotation = 0.0F, .tint = 0.1F}, 0.1F,
                          0.001F);
    skull.setIncrementParticles(Vector2{-0.005F, 0.008F}, 0.0F, ColorF{-2.0F, -2.0F, -2.0F, -2.7F});
