...
void AssetStore::loadVFXs() {
    ...
    test.setStatic(Vector3{}, Vector3{1.0F, 1.0F, 1.0F}, Vector3{0.0F, -0.002F, 0.0F}, 180.0F, 15.0F);
    ...
    test.setIncrementParticles(Vec2D{-0.005F, -0.005F}, 1.0F, ColorF{0, 0, 0, -3.0F});
    test.setIncrementEnvelope(ParticleEmitter::ParticleEnvelope{.size = 0.2F, .rotation = 0.4F, .tint = 0.1F});
