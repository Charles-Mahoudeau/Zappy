...
| `feat/`     | Used for specific features (e.g., `feature/modern-ui`). Base off `develop`. |
| `fix/`      | Preparation for a new submission/milestone.                                 |
| `refactor/` | Urgent fixes for the `main` branch.                                         |
